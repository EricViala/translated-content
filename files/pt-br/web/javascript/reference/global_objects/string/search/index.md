...
- A partir do Gecko 39, o argumento não-padrão `flags` está defasado (deprecated) e dispara um aviso no console ([Erro do Firefox 142351](https://bugzil.la/142351)).
- A partir do Gecko 47, o argumento não-padrão `flags` não é mais suportado em builds _non-release_ e em breve será removido inteiramente ([Erro do Firefox 245801](https://bugzil.la/245801)).
- A partir do Gecko 49, o argumento não-padrão `flags` não é mais suportado ([Erro do Firefox 108382](https://bugzil.la/108382)).
